...
class FaceMeshMediapipe:
    ...
    def extract_eye_brows_points(self, face_points: list) -> dict:
        ...
        if len(face_points) == self.expected_face_points:
            ...
            self.eye_brows_points['right_eyebrow'].append([coord for point in right_eyebrow_points for coord in point])
            self.eye_brows_points['left_eyebrow'].append([coord for point in left_eyebrow_points for coord in point])
        else:
    ...
    def extract_nose_points(self, face_points: list) -> dict:
    ...
    def extract_mouth_points(self, face_points: list) -> dict:
        ...
        if len(face_points) == self.expected_face_points:
            ...
            self.mouth_points['mouth_opening'].append([coord for point in mouth_opening_points for coord in point])
        else:
            raise Exception(f"face_points len: {len(face_points)} != {self.expected_face_points}")
